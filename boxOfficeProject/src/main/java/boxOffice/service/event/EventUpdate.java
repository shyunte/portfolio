...
public class EventUpdate implements CommandProcess {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			int evNum = Integer.parseInt(mr.getParameter("evNum"));
			...
			String preTitPho = mr.getParameter("preTitPho");
			String preConPho = mr.getParameter("preConPho");

			if(evTitlePhoto == null) {
				evTitlePhoto = preTitPho;
			}
			if(evContentPhoto == null) {
				evContentPhoto = preConPho;
			}
			
			event.setEvNum(evNum);
