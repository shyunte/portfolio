...
<body>
	<div id="mainContainer" align="center">
		<form action="eventUpdate.ev" name="frm" id="frm" method="post" enctype="multipart/form-data" onsubmit="return chk()">
		<input type="hidden" name="evNum" value="${evNum }">
		<input type="hidden" name="evReadCount" value="${evReadCount }">
		<input type="hidden" name="id" value="${id }">
		<input type="hidden" name="preTitPho" value="${event.evTitlePhoto }">
		<input type="hidden" name="preConPho" value="${event.evContentPhoto }">
			<table id="mainTable" class="table table-hover">
				<caption class="caption">이벤트수정</caption>
				<tr>
					<th width="18%">제목</th>
				...
				<tr>
					<th width="18%">제목사진</th>
					<td><input class="form-control" type="file" name="evTitlePhoto" accept="image/*"/>
					<th width="18%">내용사진</th>
				...
				<tr>
					<td colspan="4" align="center"><input class="btn btn-outline-dark btn-sm" type="submit" value="이벤트수정" /></td>
				</tr>
			</table>
		</form>
	</div>
